    ...
    <Section id="features" muted>
      <Container>
        <SectionHeader
          ...
          title="One platform. Zero dependencies."
          subtitle="Everything from AI content generation to Stripe billing — built in, not bolted on."
        />
          ...
          {FEATURES.map((f) => {
            ...
            return (
              <Card as="li" key={f.title}>
                <div className={`w-12 h-12 ${colors.bg} ${colors.border} border rounded-xl flex items-center justify-center mb-5`} aria-hidden="true">
